...
const changePassword = (oldPassword, newPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isOldPasswordMatch) {
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, "Old Password doest not match");
    }
...
const setPassword = (userId, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.password && user.auths.some(providerObject => providerObject.provider === 'google')) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "You have already set you password. Now you can change the password form your profile password update");
    }
...
const forgotPassword = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User doest not exist");
    }
    ...
    // http://localhost:5173/reset-password?id=6883793ce4a1db5bb1a4f0f3&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2ODgzNzkzY2U0YTFkYjViYjFhNGYwZjMiLCJlbWFpbCI6ImVtb25iYWZzZEBnbWFpbC5jb20iLCJyb2xlIjoiVVNFUiIsImlhdCI6MTc1MzQ0Njc5OSwiZXhwIjoxNzUzNDQ3Mzk5fQ.GLwwD08D3Pdi5IZrUS7WvXEYfRXs8qHk_foT7y3yX4w
});
